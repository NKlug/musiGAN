...
from bar import to_midi_pitch, save_as_midi, dataset_from_midi
...
from params import num_notes, magnitude_notes, rand_dim
...
class Model(object):
    ...
    def train(self, sess, checkpoint):
        ...
        real_data = dataset_from_midi('/home/nklug/mgan/mtclc.mid')
...
if __name__ == '__main__':
    ...
    with tf.Session() as sess:
        ...
        for i, gen in enumerate(generated):
            generated = to_midi_pitch(gen)
            save_as_midi(generated, os.path.join(out_dir, 'out_{}_{}.mid'.format(num_notes, i)))
